        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-slate-900">Edit Jadwal</h3>
                    <p class="mt-1 text-sm text-slate-600">
                        Perbarui informasi jadwal kegiatan.
                    </p>
                </div>
            </div>
                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="kelas" id="kelas" value="{{ old('kelas', $jadwal->kelas) }}" class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="kegiatan" id="kegiatan" value="{{ old('kegiatan', $jadwal->kegiatan) }}" class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-md">
                                    @error('kegiatan') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                                </div>

                                @php
                                    // Split waktu string "07:00 - 08:00" into parts
                                    $times = explode(' - ', $jadwal->waktu);
                                    $jam_mulai = $times[0] ?? '';
                                    $jam_selesai = $times[1] ?? '';
                                @endphp
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="time" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai', $jam_mulai) }}" class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="time" name="jam_selesai" id="jam_selesai" value="{{ old('jam_selesai', $jam_selesai) }}" class="mt-1 focus:ring-primary-500 focus:border-primary-500 block w-full shadow-sm sm:text-sm border-slate-300 rounded-md">
